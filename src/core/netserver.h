...
const char fm_html[] PROGMEM = R"fm(
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
  ...
  <script type="text/javascript" src="variables.js"></script>
  <script type="text/javascript" src="script.js"></script>
  <title>ёRadio - FM Stations</title>
</head>
<body>
<div id="content" class="hidden progmem">
  <div id="player">
    <div id="pl">
      <div id="plhead">
        <div id="pltitle">FM Stations</div>
      </div>
      <div id="pllist">
        <form method="POST" action="/fm">
          <textarea name="fmstations" id="fmtextarea" rows="20" cols="50" placeholder="Enter FM frequencies, one per line (e.g. 104.9)"></textarea><br>
          <input type="submit" value="Save FM Stations">
          <button type="button" onclick="document.getElementById('fmtextarea').value='';">Clear</button>
        </form>
      </div>
    </div>
  </div>

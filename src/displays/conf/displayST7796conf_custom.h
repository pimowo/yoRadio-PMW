...
const WidgetConfig voltxtConf PROGMEM = {0, DSP_HEIGHT - 34, 2, WA_CENTER};         // Widget głośności - ustawiony na wysokość słupków RSSI
const WidgetConfig iptxtConf PROGMEM = {TFT_FRAMEWDT, DSP_HEIGHT - 34, 2, WA_LEFT}; // Widget IP - ustawiony na wysokość słupków RSSI
const WidgetConfig rssiConf PROGMEM = {TFT_FRAMEWDT, DSP_HEIGHT - 34, 2, WA_RIGHT}; // Widget RSSI WiFi
const WidgetConfig rssiNumConf PROGMEM = {(TFT_FRAMEWDT + 30), DSP_HEIGHT - 34, 2, WA_RIGHT}; // Numeric RSSI
...
const char numtxtFmt[] PROGMEM = "%ddB";       // Format numeru
